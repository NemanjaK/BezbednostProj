...
public class WriteMailClient extends MailClient {
	...
	public static void main(String[] args) {
        ...
        try {
            ...
            final String path = "./data/" + senderEmail + "_enc.xml";
			...
			DataUtil.generateXML(senderEmail, subject, body);
			
        	SignEnveloped.testIt(senderEmail);
    
        	// Enkriptovanje
            AsymmetricKeyEncryption.testIt(senderEmail, reciever);
            
            MimeMessage mimeMessage = MailHelper.createMimeMessage(reciever, path);
